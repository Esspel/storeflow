    ...
    <div className="mx-auto max-w-3xl px-5 py-8 md:px-8 md:py-12">
      ...
      <div className="prose prose-sm max-w-none space-y-8 text-coop-gray-900">
        <section>
          ...
          <p className="text-coop-gray-900 leading-relaxed">
        ...
        <section>
          ...
          <ul className="space-y-2 text-coop-gray-900">
        ...
        <section>
          ...
          <p className="text-coop-gray-900 leading-relaxed mb-2">
            Vi behandlar personuppgifter för att:
          </p>
          <ul className="list-disc list-inside space-y-1 text-coop-gray-900">
        ...
        <section>
          ...
          <p className="text-coop-gray-900 leading-relaxed mb-2">Enligt GDPR har du rätt att:</p>
          <ul className="list-disc list-inside space-y-1 text-coop-gray-900">
          ...
          <p className="mt-3 text-coop-gray-900 leading-relaxed">
