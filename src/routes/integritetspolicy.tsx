...
function PrivacyPolicyPage() {
  return (
    <div className="mx-auto max-w-3xl px-5 py-8 md:px-8 md:py-12">
      ...
      <div className="prose prose-sm max-w-none space-y-8 text-coop-gray-900">
        <section>
          <h2 className="text-xl font-semibold mb-3">1. Personuppgiftsansvarig</h2>
          <p className="text-coop-gray-600 leading-relaxed">
            StoreFlow är ett internt verksamhetssystem. Den organisation eller det företag som
            administrerar er StoreFlow-installation är personuppgiftsansvarig för de uppgifter som
            behandlas i systemet.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-semibold mb-3">2. Vilka uppgifter samlar vi in?</h2>
          <ul className="space-y-2 text-coop-gray-600">
            <li className="flex gap-2">
              <span className="text-coop-gray-900 font-medium shrink-0">Kontouppgifter:</span>{" "}
              Användarnamn, visningsnamn, lösenordshash (aldrig i klartext), roll och
              anställningsgrupp.
            </li>
            <li className="flex gap-2">
              <span className="text-coop-gray-900 font-medium shrink-0">Aktivitetsdata:</span>{" "}
              Uppgifter du skapar, kompletterar eller kommenterar, inklusive tidsstämplar.
            </li>
            <li className="flex gap-2">
              <span className="text-coop-gray-900 font-medium shrink-0">Avvikelserapporter:</span>{" "}
              Beskrivningar, bilder och statusinformation kopplade till specifika ärenden.
            </li>
            <li className="flex gap-2">
              <span className="text-coop-gray-900 font-medium shrink-0">Sessionsdata:</span>{" "}
              Inloggningstidpunkt och sista inloggning för säkerhetsspårning.
            </li>
            <li className="flex gap-2">
              <span className="text-coop-gray-900 font-medium shrink-0">Pushnotiser:</span>{" "}
              Prenumerationstokens om du väljer att aktivera notiser (lagras lokalt och i
              databasen).
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-coop-gray-600 leading-relaxed mb-2">
            Vi behandlar personuppgifter för att:
          </p>
          <ul className="list-disc list-inside space-y-1 text-coop-gray-600">
        ...
        <section>
          ...
          <p className="text-coop-gray-600 leading-relaxed">
            Behandlingen sker med stöd av <strong>berättigat intresse</strong> (art. 6.1 f GDPR) att
            administrera och driva verksamheten effektivt, samt i förekommande fall
        ...
        <section>
          ...
          <p className="text-coop-gray-600 leading-relaxed">
            ...
            konfigurerat (standard 365 dagar för avklarade uppgifter). Revisionsloggar behålls i 90
            dagar.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-coop-gray-600 leading-relaxed mb-2">Enligt GDPR har du rätt att:</p>
          <ul className="list-disc list-inside space-y-1 text-coop-gray-600">
            ...
            <li>
              Begära dataportabilitet (export av dina uppgifter via Inställningar &rarr;
              GDPR-export).
            </li>
          </ul>
          <p className="mt-3 text-coop-gray-600 leading-relaxed">
        ...
        <section>
          ...
          <p className="text-coop-gray-600 leading-relaxed">
            Alla lösenord hanteras som bcrypt-hashar och lagras aldrig i klartext. Dataöverföring
            sker krypterat via HTTPS/TLS. Databasen är skyddad med Row Level Security (RLS) som
            säkerställer att varje användare bara kan läsa och skriva data de är behöriga till.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-coop-gray-600 leading-relaxed">
            ...
            Supabase är certifierat enligt SOC 2 och GDPR-kompatibelt. Inga uppgifter säljs eller
            delas med obehöriga tredjeparter.
          </p>
        </section>
      </div>
    </div>
