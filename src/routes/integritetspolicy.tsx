        ...
        <section>
          ...
          <ul className="space-y-2 text-muted-foreground">
            <li className="flex gap-2">
              <span className="text-foreground font-medium shrink-0">Kontouppgifter:</span>{" "}
              Användarnamn, visningsnamn, lösenordshash (aldrig i klartext), roll och
              anställningsgrupp.
            </li>
            <li className="flex gap-2">
              <span className="text-foreground font-medium shrink-0">Aktivitetsdata:</span>{" "}
              Uppgifter du skapar, kompletterar eller kommenterar, inklusive tidsstämplar.
            </li>
            <li className="flex gap-2">
              <span className="text-foreground font-medium shrink-0">Avvikelserapporter:</span>{" "}
              Beskrivningar, bilder och statusinformation kopplade till specifika ärenden.
            </li>
            <li className="flex gap-2">
              <span className="text-foreground font-medium shrink-0">Sessionsdata:</span>{" "}
              Inloggningstidpunkt och sista inloggning för säkerhetsspårning.
            </li>
            <li className="flex gap-2">
              <span className="text-foreground font-medium shrink-0">Pushnotiser:</span>{" "}
