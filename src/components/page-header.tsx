  ...
  return (
    <div className="mb-6 flex flex-col gap-3 md:mb-8 md:flex-row md:items-end md:justify-between">
      <div>
        ...
        {description && <p className="mt-1 text-sm text-muted-foreground coop-font-body">{description}</p>}
      </div>
...
export function StatCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-border/60 bg-card p-5 shadow-[var(--shadow-sm)] transition-shadow hover:shadow-[var(--shadow-md)]">
